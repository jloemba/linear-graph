...
public class GraphController {
        ...
        private final FindGraphByIdUseCase findGraphByIdUseCase;
        ...
        public GraphController(
                        ...
                        FindGraphByIdUseCase findGraphByIdUseCase) {
                ...
                this.findGraphByIdUseCase = findGraphByIdUseCase;
        ...
        // -------------------------
        @GetMapping("/{graphId}")
        public ResponseEntity<FindGraphByIdUseCase.Result> findGraphById(
                        @PathVariable UUID graphId) {
                return ResponseEntity.ok(
                                findGraphByIdUseCase.execute(new FindGraphByIdUseCase.Query(graphId)));
        }
