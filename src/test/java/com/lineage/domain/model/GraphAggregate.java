...
class GraphAggregateTest {
    ...
    @BeforeEach
    void setUp() {
        graph = new GraphAggregate("TestGraph");
    }
    ...
    class Construction {
        ...
        void shouldRejectBlankName() {
            assertThatThrownBy(() -> new GraphAggregate("  "))
        ...
        void shouldRejectNullName() {
            assertThatThrownBy(() -> new GraphAggregate(null))
                .isInstanceOf(IllegalArgumentException.class);
        }
    ...
    class NodeManagement {
        ...
        void shouldThrowWhenRemovingNonExistentNode() {
            Node node = new Node("Ghost", null, PERSON);
        ...
        void shouldCascadeDeleteRelationshipsWhenNodeIsRemoved() {
            ...
            Node b = new Node("Bob",   null, PERSON);
            graph.addNode(a);
            graph.addNode(b);
        ...
        void shouldFindNodesByType() {
            Node person  = new Node("Alice",         null, PERSON);
